...
$mod_strings = array(
	...
	'note_command' => '**note {user/who} [1-5] "text/comment"**: It will create a new record in cbSurveyDone module that will take the user selected and the note written in the command',
